...
import com.xsushirollx.sushibyte.restaurantservice.service.MyImageService;
...
//                                            @RequestPart("category") Integer category) {
        ...
        ResponseEntity<Food> addNewFoodMenuItem(@RequestBody Food newFood){


                FoodService foodService = new FoodService();
                MultipartFile image = new MyImageService(newFood.getImage());
        ...
        if (restaurantExistsController.
            ...
            return new ResponseEntity<>(repository.findById(id).map(
                    Food -> {
                        ...
                        if (newFood.getImage() != null) Food.setImage(foodService.prepImage(newFood.getImage()));
