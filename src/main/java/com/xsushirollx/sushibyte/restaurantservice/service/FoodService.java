...
//        RestaurantService restaurantExistsControllerService = new RestaurantService(restaurantRepository);

        //Checking to see if corresponding Restaurant exists
        if (restaurantControllerService.
                findById(newFood.getRestaurantID().longValue()) != null) {
